...
class Graphics:
    infile = 'D:\\Python_all\\pythonholder\\practice_project\\NaTong\\NaTong_deeplearning\\image_preprocessing\\out02.png'
    outfile = 'D:\\Python_all\\pythonholder\\practice_project\\NaTong\\NaTong_deeplearning\\image_preprocessing\\suofang.bmp'
    ...
    def resize_by_width(cls, w_divide_h):
        ...
        (x, y) = im.size
        x_s = x
        y_s = int(x / w_divide_h)
        out = im.resize((x_s, y_s), Image.ANTIALIAS).resize((512,512))
        out.save(cls.outfile)
...
# Graphics.fixed_size(512,512)
Graphics.resize_by_width(2)